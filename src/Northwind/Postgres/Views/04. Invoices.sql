...
SELECT orders.ship_name, orders.ship_address, orders.ship_city, orders.ship_region, orders.ship_postal_code, 
	orders.ship_country, orders.customer_id, customers.company_name AS CustomerName, customers.address, customers.city, 
	customers.region, customers.postal_code, customers.country, CONCAT(first_name, ' ', last_name) AS sales_person, 
	...
	order_details.discount, (order_details.unit_price* quantity * (1 - discount) / 100) * 100 AS extended_price, orders.freight
