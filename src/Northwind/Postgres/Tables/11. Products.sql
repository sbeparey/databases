...
CREATE TABLE products (
    ...
    unit_price              REAL            NULL    CONSTRAINT df_products__unit_price DEFAULT (0),
    units_in_stock          SMALLINT        NULL    CONSTRAINT df_products__units_in_stock DEFAULT (0),
    units_on_order          SMALLINT        NULL    CONSTRAINT df_products__units_on_order DEFAULT (0),
    reorder_level           SMALLINT        NULL    CONSTRAINT df_products__reorder_level DEFAULT (0),
    discontinued            BOOLEAN         NULL    CONSTRAINT df_products__discontinued DEFAULT (FALSE),
